...
export function PdfPage({
  ...
  return (
    <section
      aria-label={t('signPdf.fieldView.pageAria', {
        page: info.index + 1,
        defaultValue: `Page ${info.index + 1}`,
      })}
    ...
    >
      ...
      >
        ...
        {dragOver ? (
          <div className="pointer-events-none absolute inset-0 bg-emerald-600/5 ring-2 ring-inset ring-emerald-600" />
        ) : null}
