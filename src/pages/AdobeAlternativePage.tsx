    ...
    <div className="min-h-screen bg-surface py-8 px-4 sm:px-6 lg:px-8 font-sans text-on-surface transition-colors duration-200">
      ...
      <div className="max-w-4xl mx-auto space-y-16" id="adobe_alternative_container">
        ...
        >
          ...
          <span>
            {t('adobeAlternative.backToTools', { defaultValue: 'Back to All PDF Tools' })}
          </span>
        </Link>
        ...
        <header className="text-center space-y-6 pt-2 pb-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-bold tracking-wide uppercase">
            ...
            <span>
              {t('adobeAlternative.alternativeSubtitle', {
                defaultValue: 'Free Adobe Acrobat Alternative',
              })}
            </span>
          </div>
          ...
          <div className="pt-4 flex flex-col items-center gap-4">
            ...
            >
              <span>
                {t('adobeAlternative.startWithAnyTool', { defaultValue: 'Start with any tool' })}
              </span>
            ...
            <div className="text-xs sm:text-sm font-semibold text-on-surface-variant/80 flex flex-wrap justify-center items-center gap-2 sm:gap-3 pt-2">
              <span>
                {t('adobeAlternative.noAccount', { defaultValue: 'No account required' })}
              </span>
              ...
              <span className="text-border-muted">•</span>
              <span>
                {t('adobeAlternative.noSubscription', { defaultValue: 'No subscription' })}
              </span>
            </div>
          </div>
        </header>
        ...
        <section className="space-y-6 bg-surface-container-low border border-border-muted rounded-3xl p-6 sm:p-8 shadow-sm">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-on-surface-variant italic leading-relaxed">
              "Honest" is the operative word — a table that overclaims will get called out in a
              review or a Reddit thread, and that costs more trust than it gains.
            </p>
          </div>
            ...
            <table className="w-full text-left text-xs sm:text-sm border-collapse">
              <thead>
                <tr className="border-b border-border-muted bg-surface-container-high/60">
                  <th className="py-4 px-4 sm:px-6 font-bold text-on-surface">
                    {t('adobeAlternative.featCol')}
                  </th>
                  <th className="py-4 px-4 sm:px-6 font-bold text-on-surface w-1/3">
                    {t('adobeAlternative.acrobatCol')}
                  </th>
              ...
              <tbody className="divide-y divide-border-muted text-on-surface-variant font-medium">
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.annualPrice')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-rose-500 font-bold">
                    ~$19.99/mo ($239.88/yr)
                  </td>
                ...
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.setupInstall')}
                  </td>
                ...
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.mergePdfs')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500">
                    {t('adobeAlternative.combineFiles')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500 bg-emerald-500/5">
                    {t('adobeAlternative.visualReorder')}
                  </td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.splitRange')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500">
                    {t('adobeAlternative.organizePages')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500 bg-emerald-500/5">
                    {t('adobeAlternative.visualSelect')}
                  </td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.grayCompress')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500">
                    {t('adobeAlternative.rasterResample')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500 bg-emerald-500/5">
                    {t('adobeAlternative.streamDeflate')}
                  </td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.rotateDelete')}
                  </td>
                ...
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.watermarkPages')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500">✅</td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500 bg-emerald-500/5">✅</td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.protectUnlock')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500">
                    {t('adobeAlternative.aes128256')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-500/5">
                ...
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.metaScrub')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500">
                    {t('adobeAlternative.sanitizeDoc')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-500/5">
                ...
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.imgConversion')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500">✅</td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500 bg-emerald-500/5">
                    {t('adobeAlternative.highDpiCanvas')}
                  </td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.eSignature')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500">
                    {t('adobeAlternative.adobeSign')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500 bg-emerald-500/5">
                    {t('adobeAlternative.drawFlatten')}
                  </td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
                    {t('adobeAlternative.offlineCap')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-amber-500">
                    {t('adobeAlternative.requires30Day')}
                  </td>
                  <td className="py-3.5 px-4 sm:px-6 text-emerald-500 bg-emerald-500/5">
                    {t('adobeAlternative.offlinePwa')}
                  </td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 sm:px-6 font-semibold text-on-surface">
        ...
        <section className="space-y-6 bg-surface-container-low border border-border-muted rounded-3xl p-6 sm:p-8 shadow-sm">
          <div className="space-y-2">
            ...
            <p className="text-sm text-on-surface-variant font-medium leading-relaxed">
              When evaluated across multi-year operating horizons, paying recurring SaaS fees for
              routine PDF administrative tasks creates massive financial waste:
            </p>
          </div>
              ...
              <thead>
                <tr className="border-b border-border-muted bg-surface-container-high/60">
                  <th className="py-3.5 px-4 font-bold text-on-surface">
                    {t('adobeAlternative.teamSize')}
                  </th>
                  <th className="py-3.5 px-4 font-bold text-on-surface">
                    {t('adobeAlternative.cost1Year')}
                  </th>
                  <th className="py-3.5 px-4 font-bold text-on-surface">
                    {t('adobeAlternative.cost3Years')}
                  </th>
                  <th className="py-3.5 px-4 font-bold text-on-surface">
                    {t('adobeAlternative.cost5Years')}
                  </th>
                  ...
                  <th className="py-3.5 px-4 font-bold text-emerald-600 dark:text-emerald-400">
                    {t('adobeAlternative.totalSavings')}
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border-muted text-on-surface-variant font-medium">
                <tr>
                  ...
                  <td className="py-3 px-4 text-emerald-600 dark:text-emerald-400 font-black bg-emerald-500/5">
                    $0.00
                  </td>
          ...
          <p className="text-xs sm:text-sm text-on-surface-variant font-medium leading-relaxed">
            * Plus Adobe's 50% early termination fee on remaining contracts and the sunset of
            perpetual licenses like Acrobat 2020. With PDFMinty, you get zero contracts, zero
            recurring invoices, and zero upgrade walls.
          </p>
        </section>
        ...
        <section className="space-y-6 bg-surface-container-low border border-border-muted rounded-3xl p-6 sm:p-8 shadow-sm">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-on-surface tracking-tight">
            {t('adobeAlternative.whySwitching', {
              defaultValue: 'Why people are switching right now',
            })}
          </h2>

          <div className="space-y-4 text-sm sm:text-base text-on-surface-variant leading-relaxed font-medium">
            <p>
              Adobe Acrobat's subscription price has been a recurring complaint for years, and it
              hasn't gotten cheaper. If you only need the PDF tasks most people actually do —
              combining files before sending them, shrinking a file to fit an email limit, pulling
              out a few pages, adding a signature or a password — a full Creative Cloud subscription
              is a lot of tool for a small job.
            </p>
            <p>
              PDFMinty covers the tasks that make up the bulk of everyday PDF work, and does it
              entirely in your browser: nothing is uploaded to a server, so there's nothing to wait
              on and nothing to worry about later.
            </p>
          </div>
        </section>
        ...
        <section id="pick-your-task" className="space-y-6 scroll-mt-20">
          <div className="space-y-2">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-on-surface tracking-tight">
              {t('adobeAlternative.pickTask', { defaultValue: 'Pick your task' })}
            </h2>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3.5 pr-3">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${t.color}`}
                    >
        ...
        <section
          className="bg-surface-container-low border border-border-muted rounded-3xl p-6 sm:p-10 shadow-sm space-y-8 text-on-surface"
          id="adobe_in_depth_comparison"
        >
          <div className="space-y-3">
            ...
            <p className="text-sm sm:text-base text-on-surface-variant leading-relaxed">
              For decades, Adobe Acrobat Pro has remained the enterprise default for PDF
              manipulation. However, annual subscription costs exceeding $240/year per user, heavy
              background telemetry processes, and forced cloud synchronizations have prompted
              businesses, researchers, and individuals to adopt lightweight, client-side
              alternatives.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-surface p-6 rounded-2xl border border-border-muted space-y-3">
              ...
              <p className="text-xs sm:text-sm text-on-surface-variant leading-relaxed">
                Standard desktop PDF editors require multi-gigabyte installations, continuous
                licensing verification checks, and mandatory document uploading for basic tasks like
                document compression or mobile sharing. For teams that only require standard merge,
                split, annotate, and sanitize capabilities, this creates substantial recurring
                overhead.
              </p>
            </div>
            ...
            <div className="bg-surface p-6 rounded-2xl border border-border-muted space-y-3">
              ...
              <p className="text-xs sm:text-sm text-on-surface-variant leading-relaxed">
                PdfMinty utilizes compiled WebAssembly binaries (`pdf-lib`, `pdfjs-dist`) that
                execute locally inside your web browser sandbox. You achieve near-native execution
                speed without installing desktop binaries or risking document confidentiality across
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-2xl bg-surface border border-border-muted space-y-2">
                <span className="inline-block px-2.5 py-1 rounded-full text-xs font-bold bg-rose-500/10 text-rose-500">
                  {t('adobeAlternative.gen1')}
                </span>
                <h4 className="font-bold text-sm text-on-surface">
                  {t('adobeAlternative.competitorDesktop', {
                    defaultValue: 'Adobe Acrobat, Foxit, Nitro',
                  })}
                </h4>
              ...
              <div className="p-4 rounded-2xl bg-surface border border-border-muted space-y-2">
                <span className="inline-block px-2.5 py-1 rounded-full text-xs font-bold bg-amber-500/10 text-amber-500">
                  {t('adobeAlternative.gen2')}
                </span>
                <h4 className="font-bold text-sm text-on-surface">
                  {t('adobeAlternative.competitorWeb', {
                    defaultValue: 'Smallpdf, iLovePDF, Soda',
                  })}
                </h4>
                <p className="text-xs text-on-surface-variant leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-surface border border-emerald-500/30 bg-emerald-500/5 space-y-2">
                <span className="inline-block px-2.5 py-1 rounded-full text-xs font-bold bg-emerald-500/20 text-emerald-600 dark:text-emerald-400">
                  {t('adobeAlternative.gen3')}
                </span>
                <h4 className="font-bold text-sm text-emerald-700 dark:text-emerald-300">
                  {t('adobeAlternative.pdfmintyLabel', { defaultValue: 'PDFMinty' })}
                </h4>
                <p className="text-xs text-on-surface-variant leading-relaxed">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">
              {t('adobeAlternative.whenAcrobatNeeded', {
                defaultValue: 'When Is Acrobat Still Necessary?',
              })}
            </h3>
            <p className="text-xs sm:text-sm text-on-surface-variant leading-relaxed">
              We believe in honest technology recommendations. You should retain Adobe Acrobat Pro
              if your workflow strictly requires:
            </p>
        ...
        <section className="space-y-6 bg-surface-container-low border border-border-muted rounded-3xl p-6 sm:p-8 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-on-surface tracking-tight">
                {t('adobeAlternative.faqTitle', { defaultValue: 'Frequently Asked Questions' })}
              </h2>
              <p className="text-xs sm:text-sm text-on-surface-variant font-medium">
                {t('adobeAlternative.faqDesc', {
                  defaultValue:
                ...
                >
                  ...
                  {isOpen && (
                    <div className="px-5 pb-5 pt-1 text-xs sm:text-sm text-on-surface-variant leading-relaxed font-medium border-t border-border-muted/50">
                      {i === 4 ? (
                        <p>
                          Since your file never leaves your device, there's no upload step and no
                          server storing a copy of your document — see our related post on{' '}
                          <Link
        ...
        <section className="text-center bg-gradient-to-br from-emerald-600 to-teal-700 text-white rounded-3xl p-8 sm:p-12 space-y-6 shadow-xl">
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight">
            {t('adobeAlternative.stopPayingTitle', {
              defaultValue: 'Stop paying to move pages around.',
            })}
          </h2>
          <p className="text-base sm:text-lg font-bold text-emerald-100 max-w-xl mx-auto">
            {t('adobeAlternative.everyToolDesc', {
              defaultValue: 'Every tool. No account. No upload. No cost.',
            })}
          </p>
          <div className="pt-2">
            <Link
